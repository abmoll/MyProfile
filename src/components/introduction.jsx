                  ...
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
                      <div className="slider-text-inner js-fullheight">
                        <div className="desc">
                          <h1 style={{padding: '0 10px 0 10px', borderRadius:'8px', background:'rgba(242, 243, 247, 0.9)', fontFamily: 'Optima', fontWeight: '100'}}>Alex Moll</h1>
                  ...
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          <h1 style={{padding: '0 10px 0 10px', borderRadius:'8px', background:'rgba(242, 243, 247, 0.9)', fontFamily: 'Optima', fontWeight: '100'}}>Web Developer</h1>
