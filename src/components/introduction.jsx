                  ...
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
                      <div className="slider-text-inner js-fullheight">
                        <div className="desc">
                          <h1 style={{padding: '0 10px 0 10px', borderRadius:'8px', background:'rgba(247, 231, 212, 0.7)', fontFamily: 'Optima', fontWeight: '100'}}>Alex Moll</h1>
                  ...
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          <h1 style={{padding: '0 10px 0 10px', borderRadius:'8px', background:'rgba(247, 231, 212, 0.7)', fontFamily: 'Optima', fontWeight: '100'}}>Web Developer</h1>
